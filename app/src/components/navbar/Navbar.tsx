    ...
    <header className="bg-white shadow-md fixed w-full top-0 z-50">
      <div className="mx-auto max-w-[1200px] px-4 md:px-2 lg:px-8 py-4 flex items-center justify-between">
        ...
        <nav className="hidden md:flex space-x-2 sm:space-x-4 lg:space-x-8 text-black font-poppins">
          <a href="/" className="relative text-sm sm:text-base hover:text-zinc-500 transition group">
            Strona główna
          ...
          <div className="relative">
            <button className="relative flex items-center text-sm sm:text-base hover:text-zinc-500 transition group" onClick={() => toggleDropdown('osalon')}>
            O salonie
            <FontAwesomeIcon icon={dropdownOpen === 'osalon' ? faChevronUp : faChevronDown} className="ml-2"/>
              <span className="absolute left-0 bottom-[-2px] w-0 h-[2px] bg-gray-600 transition-all duration-300 group-hover:w-full"></span>
            </button>

            <div className={`absolute bg-white shadow-lg mt-2 rounded-md transition-all duration-300 overflow-hidden w-48 sm:w-56 ${dropdownOpen === 'osalon' ? 'max-h-40 opacity-100' : 'max-h-0 opacity-0'}`}>
              <a href="#dlaczego-my" className="block px-4 py-2 hover:bg-gray-100">
                Dlaczego my
              </a>
              <a href="#o-nas" className="block px-4 py-2 hover:bg-gray-100">
                O nas
              </a>
            </div>
          </div>
          ...
          {/* Usługi Dropdown */}
          <div className="relative">
            <button className="relative flex items-center text-sm sm:text-base hover:text-zinc-500 transition group" onClick={() => toggleDropdown('uslugi')}>
              Usługi
              <FontAwesomeIcon icon={dropdownOpen === 'uslugi' ? faChevronUp : faChevronDown} className="ml-2"/>
              <span className="absolute left-0 bottom-[-2px] w-0 h-[2px] bg-gray-600 transition-all duration-300 group-hover:w-full"></span>
            </button>
            <div className={`absolute bg-white shadow-lg mt-2 rounded-md transition-all duration-300 overflow-hidden w-48 sm:w-56 ${dropdownOpen === 'uslugi' ? 'max-h-40 opacity-100' : 'max-h-0 opacity-0'}`}>
              <a href="#uslugi" className="block px-4 py-2 hover:bg-gray-100">
                Usługi
              </a>
              <a href="#cennik" className="block px-4 py-2 hover:bg-gray-100">
                Cennik
              </a>
            </div>
          </div>

          <a href="#opinie" className="relative text-sm sm:text-base hover:text-zinc-500 transition group">
                Opinie
                <span className="absolute left-0 bottom-[-2px] w-0 h-[2px] bg-gray-600 transition-all duration-300 group-hover:w-full"></span>
          </a>
          <a href="#kontakt" className="relative text-sm sm:text-base hover:text-zinc-500 transition group">
                Kontakt
                <span className="absolute left-0 bottom-[-2px] w-0 h-[2px] bg-gray-600 transition-all duration-300 group-hover:w-full"></span>
          </a>
        </nav>
